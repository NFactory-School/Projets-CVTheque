...
<div class="login-wrap">
		...
		<div class="login-form">
			...
			<div class="sign-in-htm">
				...
				<div class="group">
					...
					<input type="text" placeholder="Pseudo" name="pseudo" value="<?php if(!empty($_POST['pseudo'])) {echo $_POST['pseudo'];}?>"><br>
					<?php br(); ?>
				</div>	
	...
	<form action="" method="post">
			...
			<div class="sign-up-htm">
				...
				<div class="group">
					<input type="text" placeholder="Pseudo" name="pseudo" value="<?php if(!empty($_POST['pseudo'])) {echo $_POST['pseudo'];}?>"><br>
					<span class="error"><?php if(!empty($errors['pseudo'])){echo $errors['pseudo'];};?></span><?php br(); ?>
				</div>	

				<div class="group">
					<input type="text" placeholder="Mot de passe" name="mdp" value=""><br>
